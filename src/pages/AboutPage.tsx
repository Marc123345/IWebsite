      ...
      <div className="min-h-screen">
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-serif">The iLight Team</h2>
              
              <GlassCard className="max-w-4xl mx-auto mb-8" opacity={0.1} blur="md" textShadow enhancedContrast={true}>
                <p className="text-xl text-white leading-relaxed mb-4">
                  The iLight Team is everyone who plays a part, large or small, in driving our collective Mission and Vision of Illuminating lives.
                </p>
                <p className="text-xl text-white leading-relaxed mb-4">
