              ...
              {communityFeatures.map((feature, index) => (
                <div className="mb-20\" key={feature.title}>
                  ...
                  >
                    ...
                    <div className={`relative z-[1] -mt-[118px] ${feature.isReversed ? 'mr-auto ml-5 rounded-tr-[40px] pr-5' : 'ml-auto mr-5 rounded-tl-[40px] pl-5'} md:w-[70%] bg-white lg:w-3/5 shadow-2xl`}>
